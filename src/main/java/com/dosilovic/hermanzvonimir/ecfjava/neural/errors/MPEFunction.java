...
public class MPEFunction<T extends RealVector> implements IFunction<T> {
    ...
    public MPEFunction(INeuralNetwork neuralNetwork, DatasetEntry[] dataset) {
    ...
    public double getValue(T weights) {
        ...
        return ErrorUtil.meanPercentageError(outputs, neuralNetwork.forward(inputs));
    }
}
