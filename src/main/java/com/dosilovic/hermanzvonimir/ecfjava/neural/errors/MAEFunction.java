...
public class MAEFunction<T extends RealVector> implements IFunction<T> {
    ...
    public MAEFunction(INeuralNetwork neuralNetwork, DatasetEntry[] dataset) {
    ...
    public double getValue(T weights) {
        ...
        return ErrorUtil.meanAbsoluteError(outputs, neuralNetwork.forward(inputs));
    }
}
