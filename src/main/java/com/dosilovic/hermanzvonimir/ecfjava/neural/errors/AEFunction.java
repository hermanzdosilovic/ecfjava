...
public class AEFunction<T extends RealVector> implements IFunction<T> {
    ...
    public AEFunction(INeuralNetwork neuralNetwork, DatasetEntry[] dataset) {
    ...
    public double getValue(T weights) {
        ...
        return ErrorUtil.absoluteError(outputs, neuralNetwork.forward(inputs));
    }
}
